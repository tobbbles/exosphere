...
### Internal
- BLAKE3 NIF now ships as precompiled, checksummed artifacts (rustler_precompiled) for Linux, macOS, and Windows targets; a Rust toolchain is only needed to build from source (#32)
