  ...
  defp package do
    [
      ...
      files: [
        ...
        "native/exosphere_blake3/.cargo",
        "native/exosphere_blake3/Cargo.toml",
        "native/exosphere_blake3/Cargo.lock",
        # rustler_precompiled verifies downloaded NIF artifacts against this
        # file (generated by the release workflow); the package is broken
        # without it.
        "checksum-*.exs",
        "mix.exs",
        "README.md",
